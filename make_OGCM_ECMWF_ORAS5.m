...
%  ECMWF_ORAS5 data.
%
%  Online reference to ECMWF_ORAS5 is at https://www.ecmwf.int
% 
%  Further Information:  
...
disp('=============================================')
%
%  ECMWF_ORAS5 : see in sea ECMWF_OCEAN5_request.py and others options
%
...
if makeclim==1 | makebry==1
  ...
  for Y=Ymin:Ymax
    ...
    for M=mo_min:mo_max
      ...
      if ntimes==1
	      dt=30; % monthly files (ECMWF..)
        itolap_a=1; itolap_p=1;
        itolap_tot=itolap_a + itolap_p;
        disp(['Reduced overlap for monthly ECMWF files'])
        disp(['...'])
      else
